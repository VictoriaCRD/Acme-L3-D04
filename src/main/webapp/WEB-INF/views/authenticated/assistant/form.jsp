...
<acme:form>
	...
	<acme:input-textbox code="authenticated.assistant.form.label.fields" path="fields"/>
	...
	<acme:submit test="${_command == 'update'}" code="authenticated.consumer.form.button.update" action="/authenticated/assistant/update"/>
