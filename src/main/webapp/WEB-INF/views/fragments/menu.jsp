...
<%@page language="java" import="acme.framework.helpers.PrincipalHelper,acme.roles.Provider,acme.roles.Consumer,acme.roles.Assistant"%>
...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		...
		<acme:menu-option code="master.menu.auditor" access="hasRole('Auditor')">
			...
			<acme:menu-suboption code="master.menu.auditor.auditRecords" action="/auditor/audit-record/list?masterId=${id}"/>
		</acme:menu-option>
		...
		<acme:menu-option code="master.menu.company" access="hasRole('Company')">
			...
			<acme:menu-suboption code="master.menu.company.dashboard.list" action="/company/company-dashboard/show"/>
		</acme:menu-option>
	...
	<acme:menu-right>
		...
		<acme:menu-option code="master.menu.user-account" access="isAuthenticated()">
			...
			<acme:menu-suboption code="master.menu.user-account.notes" action="/authenticated/note/list"/>
			<acme:menu-suboption code="master.menu.user-account.create-company" action="/authenticated/company/create" access="!hasRole('Company')"/>
			<acme:menu-suboption code="master.menu.user-account.update-company" action="/authenticated/company/update" access="hasRole('Company')"/>
